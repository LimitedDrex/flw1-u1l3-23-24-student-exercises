...
let creatureDescription = "red, fiery flying dragon with scales down its back";
...
let visitorAge = Math.floor(Math.random());
...
if (visitorAge > 15) {
  canVisit = true;
if (canVisit = true) {
  let visitorPass = "You may enter the zoo."; else if (canVisit = false);
  let visitorPass = "You are not allowed to enter the zoo.";
}
...
let zooSummary = "The " + creatureName + " is a " + creatureDescription + ". You are " + vistorAge;
